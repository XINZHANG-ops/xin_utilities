...
const brushIcons = {
  ...
  marker: '<polygon points="9,0.7 10.6,1.8 7.9,5.9 6.3,4.8" fill="currentColor" stroke="currentColor" stroke-width="1" stroke-linejoin="round" transform="rotate(9.1 8.5 3.3)"/><polygon points="4.8,5.3 6.4,6.4 3.7,10.5 2.1,9.4" fill="currentColor" stroke="currentColor" stroke-width="1" stroke-linejoin="round" transform="rotate(9.1 4.3 7.9)"/><ellipse cx="1.7" cy="10.6" rx="0.6" ry="0.5" fill="currentColor" stroke="currentColor" transform="rotate(-51.2 1.7 10.6)"/>',
